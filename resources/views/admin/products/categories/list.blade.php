            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions style-actions">
                        ...
                        <a href="{{ route('admin_add_products_category') }}" class="btn btn-circle blue-steel btn-outline">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                        ...
                        <tbody>
                            @foreach($listCategoryProducts as $key=>$item)
                                <tr>
                                    <td class="text-center">{{ $key+1 }}</td>
                                    <td><a href="{{ route('admin_edit_products_category' , $item->id) }}">{{ $item->name }}</a></td>
                                    <td>{{ $item->alias }}</td>
                                    <td>{{ $item->level }}</td>
