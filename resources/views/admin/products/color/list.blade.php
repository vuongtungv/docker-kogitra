...
@section('content')
    ...
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <a href="index.html">Màu sắc</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span class="active">Danh sách Màu sắc</span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Danh sách màu sắc</span>
                    </div>
                    <div class="actions style-actions">
                        {{--<a href="javascript:;" class="btn btn-circle btn-outline green">--}}
                        {{--<i class="fa fa-pencil"></i> Edit </a>--}}
                        <a href="{{ route('admin_product_color_add') }}" class="btn btn-circle blue-steel btn-outline">
