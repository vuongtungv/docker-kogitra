...
@section('content')
    ...
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <a href="index.html">Kiểu dáng</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span class="active">Danh sách kiểu dáng</span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Danh sách kiểu dáng</span>
                    </div>
                    <div class="actions style-actions">
                        {{--<a href="javascript:;" class="btn btn-circle btn-outline green">--}}
                        {{--<i class="fa fa-pencil"></i> Edit </a>--}}
                        <a href="{{ route('admin_product_style_add') }}" class="btn btn-circle blue-steel btn-outline">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                        ...
                        @foreach($listStyle as $key=>$item)
                            <tr>
                                ...
                                <td><a href="{{ route('admin_edit_product_style' , $item->id) }}">{{ $item->name }}</a></td>
                                <td>
                                    @if($item->published == 1)
                                        Hoạt động
                                    @else
