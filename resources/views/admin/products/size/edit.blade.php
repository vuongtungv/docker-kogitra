    ...
    <div class="portlet light portlet-fit portlet-form bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red sbold uppercase">Chỉnh sửa: Kích cỡ</span>
            </div>
            <div class="actions">
        ...
        <div class="portlet-body">
            ...
            @endif
            <form action="{{ route('post_admin_product_size_add') }}" id="add-banners" method="POST" role="form" enctype="multipart/form-data">
                {{ csrf_field()}}
                <div class="form-body">
