...
@section('content')
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">Danh sách menu</span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Danh sách menu</span>
                    </div>
                    <div class="actions style-actions">
                        {{--<a href="javascript:;" class="btn btn-circle btn-outline green">--}}
                            {{--<i class="fa fa-pencil"></i> Edit </a>--}}
                        <a href="{{ route('admin_add_menu') }}" class="btn btn-circle blue-steel btn-outline">
                        ...
                        <tbody>
                            @foreach($listMenu as $key=>$item)
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin_edit_menu' , $item->id) }}">{{ $item->name }}</a></td>
                                    <td>
                                        @if($parent_name)
                                            @foreach($parent_name as $key_p => $pn)
                                                @if($key_p == $key)
                                                    {{$pn}}
                                                @endif
                                            @endforeach
