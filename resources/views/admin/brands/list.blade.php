...
@section('content')
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">Danh sách brands</span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Danh sách brands</span>
                    </div>
                    <div class="actions style-actions">
                        {{--<a href="javascript:;" class="btn btn-circle btn-outline green">--}}
                        {{--<i class="fa fa-pencil"></i> Edit </a>--}}
                        <a href="{{ route('admin_add_brands') }}" class="btn btn-circle blue-steel btn-outline">
                    ...
                    <table class="table table-striped table-bordered table-hover table-style-default" id="sample_1">
                        ...
                        @foreach($listBrands as $key=>$item)
                            <tr>
                                ...
                                <td><a href="{{ route('admin_edit_brands' , $item->id) }}">{{ $item->name }}</a></td>
