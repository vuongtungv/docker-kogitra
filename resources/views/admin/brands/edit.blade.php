    ...
    <div class="portlet light portlet-fit portlet-form bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red sbold uppercase">Thêm mới: Brand</span>
            </div>
            <div class="actions">
        ...
        <div class="portlet-body">
            ...
            @endif
            <form action="{{ route('post_admin_add_brands') }}" id="add-banners" method="POST" role="form" enctype="multipart/form-data">
                {{ csrf_field()}}
                <div class="form-body">
                    ...
                    <div class="form-md-line-input form-md-floating-label">
                        <label for="brief" class="style-label-default">Tóm tắt brand</label>
